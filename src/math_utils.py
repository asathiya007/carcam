...
def _three_point_orientation(p1, p2, q):
...
def lines_intersect(lines):
    ...
    orientation1 = _three_point_orientation(line1_point1, line1_point2, line2_point1)
    orientation2 = _three_point_orientation(line1_point1, line1_point2, line2_point2)
    orientation3 = _three_point_orientation(line2_point1, line2_point2, line1_point1)
    orientation4 = _three_point_orientation(line2_point1, line2_point2, line1_point2)
    if orientation1 != orientation2 and orientation3 != orientation4:
        return True 
    elif orientation1 == 0 and _point_on_segment(line1_point1, line1_point2, line2_point1):
        return True
    elif orientation2 == 0 and _point_on_segment(line1_point1, line1_point2, line2_point2):
        return True
    elif orientation3 == 0 and _point_on_segment(line2_point1, line2_point2, line1_point1):
        return True
    elif orientation4 == 0 and _point_on_segment(line2_point1, line2_point2, line1_point2):
        return True
    return False
...
# determine if a line intersects a box
def lines_box_intersect(lines, box): 
    if lines is None: 
        return False
    box_lines = _get_box_lines(box)
    for line in lines: 
        intersection_count = 0
        for box_line in box_lines: 
            if lines_intersect([line, box_line]):
